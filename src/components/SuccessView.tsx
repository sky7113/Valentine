...
export const SuccessView = () => {
    ...
    const images = [
        ...
        `${import.meta.env.BASE_URL}us5.jpeg`,
        `${import.meta.env.BASE_URL}us6.jpeg`
    ];
                ...
                {view !== 'gallery' && (
                    ...
                    >
                        ...
                        {view === 'music-prompt' && (
                            ...
                            >
                                <img
                                    src={`${import.meta.env.BASE_URL}bear.gif`} // Reusing bear gif for prompt
                        ...
                        {view === 'selection' && (
                            <>
                                <img
                                    src={`${import.meta.env.BASE_URL}dance.gif`}
                                    alt="Happy Dance"
                                    className="w-48 h-48 mx-auto mb-6 object-contain"
                                />
                        ...
                        {view === 'hug' && (
                            ...
                            >
                                <img
                                    src={`${import.meta.env.BASE_URL}hug.gif`}
                                    alt="Hugging"
                        ...
                        {view === 'kiss' && (
                            ...
                            >
                                <img
                                    src={`${import.meta.env.BASE_URL}kiss.gif`}
                                    alt="Kissing"
                                    className="w-64 h-64 mx-auto mb-6 object-contain"
                                />
                        ...
                        {view === 'beat' && (
                            ...
                            >
                                <div className="grid grid-cols-2 gap-4 mb-6 w-full max-w-sm">
                                    <img src={`${import.meta.env.BASE_URL}beat1.gif`} alt="Beat 1" className="w-full h-32 object-contain rounded-lg shadow-md bg-purple-50" />
                                    <img src={`${import.meta.env.BASE_URL}beat2.gif`} alt="Beat 2" className="w-full h-32 object-contain rounded-lg shadow-md bg-purple-50" />
                                    <img src={`${import.meta.env.BASE_URL}beat3.gif`} alt="Beat 3" className="w-full h-32 object-contain rounded-lg shadow-md bg-purple-50" />
                                    <img src={`${import.meta.env.BASE_URL}beat4.gif`} alt="Beat 4" className="w-full h-32 object-contain rounded-lg shadow-md bg-purple-50" />
                                </div>
                        ...
                        {view === 'promise' && (
                            ...
                            >
                                <img
                                    src={`${import.meta.env.BASE_URL}promise.gif`}
                                    alt="Promise Bear"
